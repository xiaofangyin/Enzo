package com.enzo.module_a.ui.behavior;
 ...
 */
public class MAAppBarLayoutOverScrollViewBehavior extends AppBarLayout.Behavior {
    ...
    public MAAppBarLayoutOverScrollViewBehavior() {
    }

    public MAAppBarLayoutOverScrollViewBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
