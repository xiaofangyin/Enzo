...
import com.enzo.commonlib.widget.picker.picker.ex.WheelDayView
import com.enzo.commonlib.widget.picker.picker.ex.WheelMonthView
import com.enzo.commonlib.widget.picker.picker.ex.WheelYearView
import com.enzo.commonlib.widget.picker.picker.helper.DatePickerHelper
import com.enzo.commonlib.widget.picker.picker.helper.DatePicker
...
class DatePickerView @JvmOverloads constructor(context: Context,
    ...
    private fun initAttrs(context: Context, attrs: AttributeSet) {
        ...
        setTextAlign(WheelView.convertTextAlign(typedArray.getInt(R.styleable.DatePickerView_dpv_textAlign,
        ...
        setDividerType(WheelView.convertDividerType(typedArray.getInt(R.styleable.DatePickerView_dpv_dividerType,
        ...
        setCurvedArcDirection(WheelView.convertCurvedArcDirection(typedArray.getInt(R.styleable.DatePickerView_dpv_curvedArcDirection,
