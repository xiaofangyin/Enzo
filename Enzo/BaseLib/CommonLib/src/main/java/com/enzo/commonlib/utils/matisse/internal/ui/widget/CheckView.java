 ...
 */
package com.enzo.commonlib.utils.matisse.internal.ui.widget;
...
public class CheckView extends View {
    ...
    private static final int SIZE = 40; // dp
    ...
    private void init(Context context) {
        ...
        int defaultColor = ResourcesCompat.getColor(
                getResources(), R.color.xianyu_item_checkCircle_borderColor,
                getContext().getTheme());
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.mipmap.matisse_ic_check_white_18dp, context.getTheme());
    }
