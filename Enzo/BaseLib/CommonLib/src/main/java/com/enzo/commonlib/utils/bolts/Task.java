...
public class Task<TResult> {
  ...
  /**
   * @deprecated Please use {@link  com.enzo.commonlib.utils.bolts.TaskCompletionSource()} instead.
   */
  ...
  public static <TResult> Task<TResult> forResult(TResult value) {
    ...
    if (value instanceof Boolean) {
     ...
     com.enzo.commonlib.utils.bolts.TaskCompletionSource<TResult> tcs = new  com.enzo.commonlib.utils.bolts.TaskCompletionSource<>();
    tcs.setResult(value);
    return tcs.getTask();
  }
  ...
  /* package */ static Task<Void> delay(long delay, ScheduledExecutorService executor, final CancellationToken cancellationToken) {
    ...
    final  com.enzo.commonlib.utils.bolts.TaskCompletionSource<Void> tcs = new  com.enzo.commonlib.utils.bolts.TaskCompletionSource<>();
  ...
  public static <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor,
    ...
    final  com.enzo.commonlib.utils.bolts.TaskCompletionSource<TResult> tcs = new  com.enzo.commonlib.utils.bolts.TaskCompletionSource<>();
    try {
  ...
  public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> tasks) {
    ...
    final  com.enzo.commonlib.utils.bolts.TaskCompletionSource<Task<TResult>> firstCompleted = new  com.enzo.commonlib.utils.bolts.TaskCompletionSource<>();
  ...
  public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
    ...
    final  com.enzo.commonlib.utils.bolts.TaskCompletionSource<Task<?>> firstCompleted = new  com.enzo.commonlib.utils.bolts.TaskCompletionSource<>();
    final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);
  ...
  public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
    ...
    final  com.enzo.commonlib.utils.bolts.TaskCompletionSource<Void> allFinished = new  com.enzo.commonlib.utils.bolts.TaskCompletionSource<>();
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWith(
      ...
      final CancellationToken ct) {
    boolean completed;
    final  com.enzo.commonlib.utils.bolts.TaskCompletionSource<TContinuationResult> tcs = new  com.enzo.commonlib.utils.bolts.TaskCompletionSource<>();
    synchronized (lock) {
  ...
  private static <TContinuationResult, TResult> void completeImmediately(
      final  com.enzo.commonlib.utils.bolts.TaskCompletionSource<TContinuationResult> tcs,
   ...
   * @deprecated Please use {@link  com.enzo.commonlib.utils.bolts.TaskCompletionSource} instead.
   */
  public class TaskCompletionSource extends  com.enzo.commonlib.utils.bolts.TaskCompletionSource<TResult> {
