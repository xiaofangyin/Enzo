package com.enzo.module_d.structure.designpattern.proxy;
...
public class DynamicProxy {
    ...
    public static class DynamicProxy_ implements InvocationHandler {
        //　这个就是我们要代理的真实对象
        private Object subject;

        //    构造方法，给我们要代理的真实对象赋初值
        public DynamicProxy_(Object subject) {
