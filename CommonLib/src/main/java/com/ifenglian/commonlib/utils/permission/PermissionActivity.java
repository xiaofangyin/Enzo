...
public class PermissionActivity extends Activity {
    ...
    public void onRequestPermissionsResult(int requestCode, final String[] permissions, int[] grantResults) {
        Log.e("AAA", "PermissionActivity onRequestPermissionsResult requestCode: " + requestCode);
            ...
            if (PermissionUtil.verifyPermissions(grantResults)) {//有权限
                ...
                if (!PermissionUtil.shouldShowPermissions(this, permissions)) {//这个返回false 表示勾选了不再提示
                    ...
                    for (String s : permissions) {
                        if (!ActivityCompat.shouldShowRequestPermissionRationale(PermissionActivity.this, s)) {
                            //去掉已经允许的
                            if (map != null) {
                                map.remove(s);
                            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.e("AAA", "PermissionActivity onActivityResult requestCode: " + requestCode);
        //如果是从设置界面返回,就继续判断权限
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.e("AAA", "PermissionActivity onDestroy...");
        if (map != null) {
            map.clear();
            map = null;
        }
