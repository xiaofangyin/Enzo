package com.ifenglian.commonlib.widget.view.floatingmenu;
...
public class FloatingMenu extends ViewGroup {
    ...
    // 当前菜单状态
    private MenuStatu currentStatu = MenuStatu.STATUS_CLOSE;
        ...
        for (int i = 1; i < childCount; i++) {
            ...
            animationSet.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    if (currentStatu == MenuStatu.STATUS_OPEN) {
    ...
    private void changeStatu() {
        currentStatu = (currentStatu == MenuStatu.STATUS_OPEN) ? MenuStatu.STATUS_CLOSE : MenuStatu.STATUS_OPEN;
    }
    ...
    public boolean isOpen() {
        return currentStatu == MenuStatu.STATUS_OPEN;
    }
}
