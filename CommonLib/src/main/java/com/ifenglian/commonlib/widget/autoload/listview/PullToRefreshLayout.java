...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.lib_anim_auto_load_reverse);
        refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.lib_anim_auto_load_rotating);
        // 添加匀速转动动画
