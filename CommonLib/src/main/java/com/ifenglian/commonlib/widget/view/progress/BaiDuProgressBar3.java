...
public class BaiDuProgressBar3 extends FrameLayout {
    /**
     * 存放三个小球的集合
     */
    ...
    public BaiDuProgressBar3(Context context) {
        super(context);
        init();
    }

    public BaiDuProgressBar3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BaiDuProgressBar3(Context context, AttributeSet attrs, int defStyleAttr) {
