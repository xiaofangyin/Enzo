...
public class BaiDuProgressBar4 extends FrameLayout {
    ...
    public BaiDuProgressBar4(Context context) {
        super(context);
        init();
    }

    public BaiDuProgressBar4(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BaiDuProgressBar4(Context context, AttributeSet attrs, int defStyleAttr) {
