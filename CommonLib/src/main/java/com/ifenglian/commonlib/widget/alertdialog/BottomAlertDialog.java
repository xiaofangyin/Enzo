package com.ifenglian.commonlib.widget.alertdialog;
...
public class BottomAlertDialog extends Dialog {
    ...
    private void findView() {
        ...
        for (int i = 0; i < mBuilder.mItems.size(); i++) {
            ...
            textView.setBackground(getContext().getResources().getDrawable(R.drawable.lib_photo_choose_selector));
        ...
        tvCancel.setText(mBuilder.mCancel);
